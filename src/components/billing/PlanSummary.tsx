...
const PlanSummary = ({credits ,user ,products ,subscription}:PlanSummaryProps) => {
            ...
            <div className='grid grid-cols-8 gap-4'>
                ...
                <div className='col-span-5 flex flex-col pr-12'>
                    <div className='flex-1 text-sm font-normal flex w-full justify-between pb-1'>
                        <span className='font-normal text-muted-foreground ml-1 lowercase'>Image Generation Credits Left.</span>
                ...
                <div className='col-span-5 flex flex-col pr-12'>
                    <div className='flex-1 text-sm font-normal flex w-full justify-between pb-1'>
                        <span className='font-normal text-muted-foreground ml-1 lowercase'>Model training credits left.</span>
                        <span className='font-medium'> 0 remaining</span>
                    </div>
                    <div className='mb-1 flex items-end'>
                        <Progress value={0} className='w-full h-2' />
            ...
            <div className='grid grid-cols-8 gap-4'>
                ...
                <div className='col-span-3 flex flex-row justify-between flex-wrap'>
                    ...
                    <div className='flex flex-col pb-0'>
                        ...
                        <div className='flex-1 pt-1 text-sm font-medium'>{maxImageGenCount}</div>
                    </div>
                    <div className='flex flex-col pb-0'>
                        <div className='text-sm font-normal'>Renewal Date</div>
                        <div className='flex-1 pt-1 text-sm font-medium'>{format(new Date(subscription.current_period_end),'MMM d, yyy')}</div>
                    </div>
                </div>
            </div>
